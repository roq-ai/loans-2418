...
import { getLoans, deleteLoanById } from 'apiSdk/loans';
...
export function LoanListPage(props: LoanListPageProps) {
  ...
  const { data, error, isLoading, mutate } = useSWR<PaginatedInterface<LoanInterface>>(
    () => `/loans?params=${JSON.stringify(params)}`,
    fetcher,
  );
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'cashback', header: 'cashback', accessorKey: 'cashback' },
